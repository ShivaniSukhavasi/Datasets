...
CREATE DATABASE northwind CHAR SET utf8mb4 COLLATE utf8mb4_0900_ai_ci; 


USE northwind;

-- Set SQL mode for case-insensitive identifiers and relaxed constraints
SET SESSION sql_mode = 'IGNORE_SPACE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION';

-- Note: Table names are case-insensitive on Windows and macOS by default
-- Column names are always case-insensitive in MySQL
-- Database uses utf8mb4_0900_ai_ci collation for case-insensitive and accent-insensitive string comparisons
